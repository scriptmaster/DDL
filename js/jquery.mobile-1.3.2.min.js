$(document).bind('pageinit', function(event){ 
	alert("pageinit:"+event.currentTarget.URL);
	if(event.currentTarget.URL.substr(event.currentTarget.URL.length-10)=='video.html') {
		alert("video.html");
		...
		.error(function(e){
			...
			if(localStorage.vi_content){
				alert('error'+localStorage.vi_content);
