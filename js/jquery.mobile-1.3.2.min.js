 ...
 document.addEventListener("deviceready", onDeviceReady, false);
    ...
    function existsFile(fileName,dwdURL){
        ...
        fileSystem.root.getFile(fileName, {
            ...
            function(){
                window.prompt("would you like to download..?");
    ...
    function downloadFile(fileName,dwdURL) {
        ...
        fileTransfer.download(dwdURL, currentDir+"/"+fileName,
           function(theFile) {
    ...
    function showLink(url){
        alert(url);
		 window.location.href='test_one.html#id=5'+'&name='+url;
        //var divEl = document.getElementById("ready");
        //var aElem = document.createElement("a");
        //aElem.setAttribute("target", "_blank");
        //aElem.setAttribute("href", url);
        //aElem.appendChild(document.createTextNode("Play Video"))
...
///video player source///
	function getvid(){
	 	...
	 	alert(name);
		var ft= document.getElementById('player2');
		ft.src=name;
	}
...
$(window).ready(function() {
    ...
    $(window).resize(function() {
        var wi = $(window).width();
		 ...
		 if (wi <=320 && hi <=480){
            $("p.testp").text('Screen width is less than  480px. Width is currently: ' + wi + 'px.','Height is currently: ' + hi + 'px.');
			$('img.resizeScreen').attr('src','img/320x480.png');
            }
			else
        if (wi <320 && hi <=568){
            $("p.testp").text('Screen width is less than  480px. Width is currently: ' + wi + 'px.');
			$('img.resizeScreen').attr('src','img/640x1136.png');
            }
        else if (wi < 374){
            $("p.testp").text('Screen width is between 480px and 640px. Width is currently: ' + wi + 'px.');
			$('img.resizeScreen').attr('src','img/720x1280.png');
            }
			else if (wi <=720){
            $("p.testp").text('Screen width is between 480px and 720px. Width is currently: ' + wi + 'px.');
			$('img.resizeScreen').attr('src','img/720.png');
            }
        else if (wi <=1036){
            $("p.testp").text('Screen width is between 720px and 1080px. Width is currently: ' + wi + 'px.');
			$('img.resizeScreen').attr('src','img/home_video.png');
            }
        else if (wi < 1200){
            $("p.testp").text('Screen width is between 1080px and 1200px. Width is currently: ' + wi + 'px.');
			$('img.resizeScreen').attr('src','img/home_video.png');
            }
        else {
